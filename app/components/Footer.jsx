...
const Footer = () => {
    return (
        <footer id="footer">
              ...
              <a href="#" className="block">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-2">
                    ...
                    <section className="px-6">
                        ...
                        <p>
                           MONDAY THROUGH FRIDAY <br /> 9:00 - 24:00 <br />SATURDAY &
                            SUNDAY <br />12:00 - 21:00
                        </p>
                    </section>
                    <section className="mb-5">
                        <h4>
            ...
            <div className="w-full bg-gray-900 text-white px-18" text-gray-500 px-10>
              <div>
              ...
              <div>
                <Link href="https://github.com/bennguyenn24" target="_blank"></Link>
                <Link href="https://www.linkedin.com/in/bennguyen24/" target="_blank"></Link>
                <Link href= "mailto:bennguyenn24@gmail.com" target="_blank"></Link>
              </div>
            </div>
        </footer>
